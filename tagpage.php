        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-text">
                    ...
                    <span>Shop | </span>
                    <?php
                    $query  = "SELECT * FROM category WHERE category_tag='$tagname';";
                    $result = mysqli_query($conn, $query);
                    while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                        <span><?php echo $row['category_tag']; ?></span>
                    <?php
                    };
                    ?>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 order-1 order-lg-2">
                <div class="product-list">
                    <div class="row">
                        <?php
                        $query  = "SELECT * FROM products WHERE category_tag='$tagname';";
                        $result = mysqli_query($conn, $query);
                        while ($row = mysqli_fetch_assoc($result)) {
                        ?>
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    ...
                                    <div class="pi-text">
                                        <div class="catagory-name"><?php echo $row['sub_name'] ?></div>
                                        <a href="#">
